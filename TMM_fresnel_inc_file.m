...
function [Rs,Ts,Rp,Tp,Msi,Mpi]=TMM_fresnel_inc_file(n,e,phi0,lambda,coh)%n is cell array
...
if any(num_index==0)
    index_string=find(num_index==0);% Here find in what place of n vector are the files
